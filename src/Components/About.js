  ...
  return (
    <Container>
      ...
      <ContentWrapper>
        ...
        {/* Descrição */}
        <Description>
          Sou um desenvolvedor apaixonado por tecnologia e sempre em busca de novo desafios. Minha jornada começou quando descobri o poder da programação e desde então, não parei mais de aprender e evoluir.
        </Description>
